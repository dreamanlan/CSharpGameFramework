...
The Build Report Tool gets much of its data from the Unity Editor's log file. Extremely large projects with large file sizes may get erronous values. If you experience this, check your Editor log file: Go to your Console View (go to Window > Console, or press ctrl + shift + C). In the Console View's upper right corner, click the button "Open Editor Log".
...
Size Breakdown: This will report how much your assets take space, per file type category (textures, meshes, sounds, scripts, etc.). This is the data as reported by the Unity log files.
