...
namespace System.Threading
{
	...
	internal struct ServerTicketType {
		[FieldOffset(0)]
	...
	public struct ServerSpinLock
	{
		ServerTicketType ticket;

		int threadWhoTookLock;
		readonly bool isThreadOwnerTrackingEnabled;

		static readonly ServerWatch sw = ServerWatch.StartNew ();

		ServerConcurrentOrderedList<int> stallTickets;
  ...
  public struct ServerSimpleRwLock
  {
    const int RwWait = 1;
    const int RwWrite = 2;
    const int RwRead = 4;
