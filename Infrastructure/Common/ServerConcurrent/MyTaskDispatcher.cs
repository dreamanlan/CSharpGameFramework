...
{
    public class MyServerTaskDispatcher
    {
        ...
        public void DebugPoolCount(MyAction<string> output)
        {
            if (m_IsPassive) {
                ...
                foreach (MyServerThread t in m_Threads) {
        ...
        public void DebugActionCount(MyAction<string> output)
        {
            if (m_IsPassive) {
        ...
        public MyServerTaskDispatcher(int threadNum, bool isPassive)
        {
            if (threadNum < 1)
                threadNum = 1;
            m_ThreadNum = threadNum;
        ...
        public MyServerTaskDispatcher(int threadNum, bool isPassive, int tickSleepTime)
        {
            if (threadNum < 1)
                threadNum = 1;
            m_ThreadNum = threadNum;
        ...
        public MyServerTaskDispatcher(int threadNum, bool isPassive, int tickSleepTime, int actionNumPerTick)
        {
            if (threadNum < 1)
                threadNum = 1;
            m_ThreadNum = threadNum;
        ...
        private MyServerThread[] m_Threads;
