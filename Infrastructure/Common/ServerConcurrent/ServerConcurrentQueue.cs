...
{
	public class ServerConcurrentQueue<T> : IEnumerable<T>, ICollection, IEnumerable
	{
		class Node
		{
			public T Value;
		...
		public ServerConcurrentQueue ()
		{
			tail = head;
		}
		
		public ServerConcurrentQueue (IEnumerable<T> collection): this()
		{
