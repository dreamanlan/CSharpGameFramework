...
{
	public class ServerConcurrentOrderedList<T>: ICollection<T>, IEnumerable<T>
  {
		class Node
		{
			public T Data;
    ...
    public ServerConcurrentOrderedList()
      : this(MyDefaultComparer<T>.Instance)
		{
			
		}

		public ServerConcurrentOrderedList (IEqualityComparer<T> comparer)
		{
			if (comparer == null)
