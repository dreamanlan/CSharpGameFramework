...
{
	public class ServerConcurrentDictionary<TKey, TValue> : IDictionary<TKey, TValue>,
	  ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>,
	  IDictionary, ICollection, IEnumerable
	{
		IEqualityComparer<TKey> comparer;

		ServerSplitOrderedList<TKey, KeyValuePair<TKey, TValue>> internalDictionary;

    public ServerConcurrentDictionary()
      : this(MyDefaultComparer<TKey>.Instance)
		{
		}

		public ServerConcurrentDictionary (IEnumerable<KeyValuePair<TKey, TValue>> collection)
      : this(collection, MyDefaultComparer<TKey>.Instance)
		{
		}
		...
		public ServerConcurrentDictionary (IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey> comparer)
			: this (comparer)
		{
		...
		// Parameters unused
		public ServerConcurrentDictionary (int concurrencyLevel, int capacity)
      : this(MyDefaultComparer<TKey>.Instance)
		{

		}

		public ServerConcurrentDictionary (int concurrencyLevel,
		...
		// Parameters unused
		public ServerConcurrentDictionary (int concurrencyLevel, int capacity, IEqualityComparer<TKey> comparer)
			: this (comparer)
		{
		...
		public TValue AddOrUpdate (TKey key, TValue addValue, MyFunc<TKey, TValue, TValue> updateValueFactory)
		{
		...
		public TValue GetOrAdd (TKey key, MyFunc<TKey, TValue> valueFactory)
		{
			CheckKey (key);
      ...
      return MyDefaultComparer<TValue>.Instance.Equals(value, pair.Value);
		...
		ICollection<T> GetPart<T> (MyFunc<KeyValuePair<TKey, TValue>, T> extractor)
		{
