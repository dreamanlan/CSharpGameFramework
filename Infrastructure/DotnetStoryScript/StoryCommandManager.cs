...
namespace DotnetStoryScript
{
    ...
    public sealed class StoryCommandManager
    {
        ...
        private StoryCommandManager()
        {
            ...
            RegisterCommandFactory("foreach", "foreach(a,b,...){command_list;}; statement, iterator is $$", new StoryCommandFactoryHelper<CommonCommands.ForeachCommand>());
            RegisterCommandFactory("looplist", "looplist(list){command_list;}; statement, iterator is $$", new StoryCommandFactoryHelper<CommonCommands.LoopListCommand>());
            RegisterCommandFactory("loop", "loop(count){command_list;}; statement, iterator is $$", new StoryCommandFactoryHelper<CommonCommands.LoopCommand>());
            ...
            RegisterCommandFactory("while", "while(condition){command_list;}; statement", new StoryCommandFactoryHelper<CommonCommands.WhileCommand>());
            RegisterCommandFactory("if", "if(condition){command_list;}elseif(condition){command_list;}else{command_list;}; statement, elseif can be zero or more, else can be zero or one", new StoryCommandFactoryHelper<CommonCommands.IfElseCommand>());
            RegisterCommandFactory("log", "log(fmt,arg,...) command, fmt equivalent to string.Format", new StoryCommandFactoryHelper<CommonCommands.LogCommand>());
            ...
            RegisterCommandFactory("dotnetcall", "dotnetcall command, internal implementation, using csharp object syntax", new StoryCommandFactoryHelper<CommonCommands.DotnetCallCommand>());
            RegisterCommandFactory("dotnetset", "dotnetset command, internal implementation, using csharp object syntax", new StoryCommandFactoryHelper<CommonCommands.DotnetSetCommand>());
            RegisterCommandFactory("collectioncall", "collectioncall command, internal implementation, using csharp object syntax", new StoryCommandFactoryHelper<CommonCommands.CollectionCallCommand>());
            RegisterCommandFactory("collectionset", "collectionset command, internal implementation, using csharp object syntax", new StoryCommandFactoryHelper<CommonCommands.CollectionSetCommand>());
            ...
            StoryFunctionManager.Instance.RegisterFunctionFactory("tan", "tan(v) function", new StoryFunctionFactoryHelper<CommonFunctions.TanFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("asin", "asin(v) function", new StoryFunctionFactoryHelper<CommonFunctions.AsinFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("acos", "acos(v) function", new StoryFunctionFactoryHelper<CommonFunctions.AcosFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("atan", "atan(v) function", new StoryFunctionFactoryHelper<CommonFunctions.AtanFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("atan2", "atan2(v1,v2) function", new StoryFunctionFactoryHelper<CommonFunctions.Atan2Function>());
            ...
            StoryFunctionManager.Instance.RegisterFunctionFactory("tanh", "tanh(v) function", new StoryFunctionFactoryHelper<CommonFunctions.TanhFunction>());
            ...
            StoryFunctionManager.Instance.RegisterFunctionFactory("exp", "exp(v) function", new StoryFunctionFactoryHelper<CommonFunctions.ExpFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("exp2", "exp2(v) function", new StoryFunctionFactoryHelper<CommonFunctions.Exp2Function>());
            ...
            StoryFunctionManager.Instance.RegisterFunctionFactory("log2", "log2(v) function", new StoryFunctionFactoryHelper<CommonFunctions.Log2Function>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("log10", "log10(v) function", new StoryFunctionFactoryHelper<CommonFunctions.Log10Function>());
            ...
            StoryFunctionManager.Instance.RegisterFunctionFactory("floortoint", "floortoint(v) function", new StoryFunctionFactoryHelper<CommonFunctions.FloorToIntFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("ceilingtoint", "ceilingtoint(v) function", new StoryFunctionFactoryHelper<CommonFunctions.CeilingToIntFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("roundtoint", "roundtoint(v) function", new StoryFunctionFactoryHelper<CommonFunctions.RoundToIntFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("bool", "bool(v) function", new StoryFunctionFactoryHelper<CommonFunctions.BoolFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("sbyte", "sbyte(v) function", new StoryFunctionFactoryHelper<CommonFunctions.SByteFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("byte", "byte(v) function", new StoryFunctionFactoryHelper<CommonFunctions.ByteFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("char", "char(v) function", new StoryFunctionFactoryHelper<CommonFunctions.CharFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("short", "short(v) function", new StoryFunctionFactoryHelper<CommonFunctions.ShortFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("ushort", "ushort(v) function", new StoryFunctionFactoryHelper<CommonFunctions.UShortFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("int", "int(v) function", new StoryFunctionFactoryHelper<CommonFunctions.IntFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("uint", "uint(v) function", new StoryFunctionFactoryHelper<CommonFunctions.UIntFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("long", "long(v) function", new StoryFunctionFactoryHelper<CommonFunctions.LongFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("ulong", "ulong(v) function", new StoryFunctionFactoryHelper<CommonFunctions.ULongFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("float", "float(v) function", new StoryFunctionFactoryHelper<CommonFunctions.FloatFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("double", "double(v) function", new StoryFunctionFactoryHelper<CommonFunctions.DoubleFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("decimal", "decimal(v) function", new StoryFunctionFactoryHelper<CommonFunctions.DecimalFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("ftoi", "ftoi(v) function", new StoryFunctionFactoryHelper<CommonFunctions.FtoiFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("itof", "itof(v) function", new StoryFunctionFactoryHelper<CommonFunctions.ItofFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("ftou", "ftou(v) function", new StoryFunctionFactoryHelper<CommonFunctions.FtouFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("utof", "utof(v) function", new StoryFunctionFactoryHelper<CommonFunctions.UtofFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("dtol", "dtol(v) function", new StoryFunctionFactoryHelper<CommonFunctions.DtolFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("ltod", "ltod(v) function", new StoryFunctionFactoryHelper<CommonFunctions.LtodFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("dtou", "dtou(v) function", new StoryFunctionFactoryHelper<CommonFunctions.DtouFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("utod", "utod(v) function", new StoryFunctionFactoryHelper<CommonFunctions.UtodFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("lerp", "lerp(a,b,t) function", new StoryFunctionFactoryHelper<CommonFunctions.LerpFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("lerpunclamped", "lerpunclamped(a,b,t) function", new StoryFunctionFactoryHelper<CommonFunctions.LerpUnclampedFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("lerpangle", "lerpangle(a,b,t) function", new StoryFunctionFactoryHelper<CommonFunctions.LerpAngleFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("smoothstep", "smoothstep(from,to,t) function", new StoryFunctionFactoryHelper<CommonFunctions.SmoothStepFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("clamp01", "clamp01(v) function", new StoryFunctionFactoryHelper<CommonFunctions.Clamp01Function>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("clamp", "clamp(v,v1,v2) function", new StoryFunctionFactoryHelper<CommonFunctions.ClampFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("approximately", "approximately(v1,v2) function", new StoryFunctionFactoryHelper<CommonFunctions.ApproximatelyFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("ispoweroftwo", "ispoweroftwo(v) function", new StoryFunctionFactoryHelper<CommonFunctions.IsPowerOfTwoFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("closestpoweroftwo", "closestpoweroftwo(v) function", new StoryFunctionFactoryHelper<CommonFunctions.ClosestPowerOfTwoFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("nextpoweroftwo", "nextpoweroftwo(v) function", new StoryFunctionFactoryHelper<CommonFunctions.NextPowerOfTwoFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("dist", "dist(x1,y1,x2,y2) function", new StoryFunctionFactoryHelper<CommonFunctions.DistFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("distsqr", "distsqr(x1,y1,x2,y2) function", new StoryFunctionFactoryHelper<CommonFunctions.DistSqrFunction>());
            ...
            StoryFunctionManager.Instance.RegisterFunctionFactory("gettypeassemblyname", "gettypeassemblyname(obj) function", new StoryFunctionFactoryHelper<CommonFunctions.GetTypeAssemblyNameFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("gettypefullname", "gettypefullname(obj) function", new StoryFunctionFactoryHelper<CommonFunctions.GetTypeFullNameFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("gettypename", "gettypename(obj) function", new StoryFunctionFactoryHelper<CommonFunctions.GetTypeNameFunction>());
            ...
            StoryFunctionManager.Instance.RegisterFunctionFactory("dotnetcall", "dotnetcall function, internal implementation, using csharp object syntax", new StoryFunctionFactoryHelper<CommonFunctions.DotnetCallFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("dotnetget", "dotnetget function, internal implementation, using csharp object syntax", new StoryFunctionFactoryHelper<CommonFunctions.DotnetGetFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("collectioncall", "collectioncall function, internal implementation, using csharp object syntax", new StoryFunctionFactoryHelper<CommonFunctions.CollectionCallFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("collectionget", "collectionget function, internal implementation, using csharp object syntax", new StoryFunctionFactoryHelper<CommonFunctions.CollectionGetFunction>());
            ...
            StoryFunctionManager.Instance.RegisterFunctionFactory("linq", "linq(obj,method,arg1,arg2,...) function, internal implementation, using obj.method(arg1,arg2,...) syntax, method can be orderby/orderbydesc/where/top, iterator is $$", new StoryFunctionFactoryHelper<CommonFunctions.LinqFunction>());
            ...
            StoryFunctionManager.Instance.RegisterFunctionFactory("newstringbuilder", "newstringbuilder() function", new StoryFunctionFactoryHelper<CommonFunctions.NewStringBuilderFunction>());
            ...
            StoryFunctionManager.Instance.RegisterFunctionFactory("stringjoin", "stringjoin(sep,list) function", new StoryFunctionFactoryHelper<CommonFunctions.StringJoinFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("stringsplit", "stringsplit(str,sep_list) function", new StoryFunctionFactoryHelper<CommonFunctions.StringSplitFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("stringtrim", "stringtrim(str) function", new StoryFunctionFactoryHelper<CommonFunctions.StringTrimFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("stringtrimstart", "stringtrimstart(str) function", new StoryFunctionFactoryHelper<CommonFunctions.StringTrimStartFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("stringtrimend", "stringtrimend(str) function", new StoryFunctionFactoryHelper<CommonFunctions.StringTrimEndFunction>());
            ...
            StoryFunctionManager.Instance.RegisterFunctionFactory("stringreplace", "stringreplace(str,key,rep_str) function", new StoryFunctionFactoryHelper<CommonFunctions.StringReplaceFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("stringreplacechar", "stringreplacechar(str,key,char_as_str) function", new StoryFunctionFactoryHelper<CommonFunctions.StringReplaceCharFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("makestring", "makestring(char1_as_str_or_int,char2_as_str_or_int,...) function", new StoryFunctionFactoryHelper<CommonFunctions.MakeStringFunction>());
            ...
            StoryFunctionManager.Instance.RegisterFunctionFactory("str2uint", "str2uint(str) function", new StoryFunctionFactoryHelper<CommonFunctions.Str2UintFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("str2long", "str2long(str) function", new StoryFunctionFactoryHelper<CommonFunctions.Str2LongFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("str2ulong", "str2ulong(str) function", new StoryFunctionFactoryHelper<CommonFunctions.Str2UlongFunction>());
            ...
            StoryFunctionManager.Instance.RegisterFunctionFactory("str2double", "str2double(str) function", new StoryFunctionFactoryHelper<CommonFunctions.Str2DoubleFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("hex2int", "hex2int(str) function", new StoryFunctionFactoryHelper<CommonFunctions.Hex2IntFunction>());
            ...
            StoryFunctionManager.Instance.RegisterFunctionFactory("shorttimestr", "shorttimestr() function", new StoryFunctionFactoryHelper<CommonFunctions.ShortTimeStrFunction>());
            StoryFunctionManager.Instance.RegisterFunctionFactory("isnullorempty", "isnullorempty(str) function", new StoryFunctionFactoryHelper<CommonFunctions.IsNullOrEmptyFunction>());
            ...
            StoryFunctionManager.Instance.RegisterFunctionFactory("readalllines", "readalllines(file) function", new StoryFunctionFactoryHelper<CommonFunctions.ReadAllLinesFunction>());
