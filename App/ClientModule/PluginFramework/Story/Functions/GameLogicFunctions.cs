...
namespace ScriptableFramework.Story.Functions
{
	    ...
	    internal sealed class OffsetSplineFunction : IStoryFunction
    {
        ...
        private IStoryFunction<List<object>> m_Spline = new StoryFunction<List<object>>();
    ...
    internal sealed class GetDialogItemFunction : IStoryFunction
    {
        ...
        private IStoryFunction<int> m_DlgId = new StoryFunction<int>();
    ...
    internal sealed class GetAiDataFunction : IStoryFunction
    {
        ...
        private IStoryFunction<string> m_DataType = new StoryFunction<string>();
        private bool m_HaveValue;
        private BoxedValue m_Value;
    }
