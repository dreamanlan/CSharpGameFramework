...
class(AiNeedKeepAway) {
	static_methods {
		__new_object = deffunc(1)args(...){
			local(__cs2dsl_newobj);__cs2dsl_newobj = newobject(AiNeedKeepAway, "g_AiNeedKeepAway", typeargs(), typekinds(), "ctor", 0, null, ...);
			return(__cs2dsl_newobj);
		}options[needfuncinfo(false)];
		cctor = deffunc(0)args(){
			callstatic(AiNeedKeepAway, "__cctor");
		};
		__cctor = deffunc(0)args(){
			if(AiNeedKeepAway.__cctor_called){
				return();
			}else{
				AiNeedKeepAway.__cctor_called = true;
			};
		}options[needfuncinfo(false)];
	};
	static_fields {
	...
	instance_methods {
		SetProxy = deffunc(0)args(this, result){
			setinstance(SymbolKind.Field, this, AiNeedKeepAway, "m_Proxy", result);
		...
		Clone = deffunc(1)args(this){
			...
			__method_ret_17_4_20_5 = newobject(AiNeedKeepAway, "g_AiNeedKeepAway", typeargs(), typekinds(), "ctor", 0, null);
		...
		Evaluate = deffunc(0)args(this, instance, handler, _params){
			...
			local(ratio); ratio = callexterninstance(getinstanceindexerstruct(true, BoxedValue, BoxedValueList, args, System.Collections.Generic.List_T, "get_Item", 1, 2), BoxedValue, "GetFloat");
			...
			if( execbinary("&&", execbinary("!=", null, npc, System.Object, System.Object, TypeKind.Class, TypeKind.Class), execbinary("!=", null, skillInfo, System.Object, System.Object, TypeKind.Class, TypeKind.Class), System.Boolean, System.Boolean, TypeKind.Structure, TypeKind.Structure), 28_8_40_9 ){
				...
				if( execbinary(">", targetId, 0, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), 30_12_39_13 ){
					...
					if( execbinary("!=", null, target, System.Object, System.Object, TypeKind.Class, TypeKind.Class), 32_16_38_17 ){
						...
						if( execbinary("<", distSqr, execbinary("*", execbinary("*", execbinary("*", ratio, ratio, System.Single, System.Single, TypeKind.Structure, TypeKind.Structure), getexterninstance(SymbolKind.Property, skillInfo, GameFramework.SkillInfo, "Distance"), System.Single, System.Single, TypeKind.Structure, TypeKind.Structure), getexterninstance(SymbolKind.Property, skillInfo, GameFramework.SkillInfo, "Distance"), System.Single, System.Single, TypeKind.Structure, TypeKind.Structure), System.Single, System.Single, TypeKind.Structure, TypeKind.Structure), 34_20_37_21 ){
							setexterninstance(SymbolKind.Property, getinstance(SymbolKind.Field, this, AiNeedKeepAway, "m_Proxy"), StorySystem.StoryValueResult, "Value", invokeexternoperatorreturnstruct(BoxedValue, BoxedValue, "op_Implicit__BoxedValue__Int32", 1));
							return();
						};
					};
				};
			};
			setexterninstance(SymbolKind.Property, getinstance(SymbolKind.Field, this, AiNeedKeepAway, "m_Proxy"), StorySystem.StoryValueResult, "Value", invokeexternoperatorreturnstruct(BoxedValue, BoxedValue, "op_Implicit__BoxedValue__Int32", 0));
		...
		ctor = deffunc(0)args(this){
			callinstance(this, AiNeedKeepAway, "__ctor");
		};
		__ctor = deffunc(0)args(this){
			if(getinstance(SymbolKind.Field, this, AiNeedKeepAway, "__ctor_called")){
				return();
			}else{
				setinstance(SymbolKind.Field, this, AiNeedKeepAway, "__ctor_called", true);
			};
		}options[needfuncinfo(false)];
	};
	instance_fields {
