...
namespace GameFramework.Story.Commands
{
    ...
    internal class ObjPatrolCommand : AbstractStoryCommand
    {
        ...
        protected override void Evaluate(StoryInstance instance, object iterator, object[] args)
        {
            ...
            m_WayPoints.Evaluate(instance, iterator, args);
            if (m_ParamNum > 2)
                m_IsLoop.Evaluate(instance, iterator, args);
        }
    ...
    internal class ObjSetCommand : AbstractStoryCommand
    {
        ...
        protected override bool ExecCommand(StoryInstance instance, long delta)
        {
            ...
            ClientModule.Instance.SceneContext.ObjectSet(uniqueId, localName, value);
            return false;
        }
    ...
    internal class ObjSetCampCommand : AbstractStoryCommand
    {
        ...
        protected override bool ExecCommand(StoryInstance instance, long delta)
        {
            EntityInfo obj = ClientModule.Instance.GetEntityById(m_ObjId.Value);
            if (null != obj) {
    ...
    internal class ObjSetSummonerIdCommand : AbstractStoryCommand
    {
        ...
        protected override bool ExecCommand(StoryInstance instance, long delta)
        {
            ...
            EntityInfo npcInfo = ClientModule.Instance.GetEntityById(objId);
            if (null != npcInfo) {
