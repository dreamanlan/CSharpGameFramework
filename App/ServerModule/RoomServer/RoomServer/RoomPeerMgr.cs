...
{
  internal class RoomPeerMgr
  {
#region 
    private static RoomPeerMgr s_Instance = new RoomPeerMgr();
    internal static RoomPeerMgr Instance
    {
    ...
    internal bool IsKeyExist(uint key)
    {
    ...
    internal bool OnPeerShakeHands(uint authKey, NetConnection conn)
    {
      RoomPeer peer;
    ...
    internal RoomPeer GetPeerByConnection(NetConnection conn)
    {
      RoomPeer peer = null;
