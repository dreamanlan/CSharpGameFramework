...
namespace GameFramework
{
    public class RoomPeer
    {
        ...
        private long m_EnterRoomTime;        // Room entry time
        private const int m_ConnectionOverTime = 20000;
        private const int m_FirstEnterWaitTime = 45000;    //Waiting time for first access, not counting timeout
        ...
        //There is no lock here but it will be operated on multiple threads
        //(the writing time is staggered)
