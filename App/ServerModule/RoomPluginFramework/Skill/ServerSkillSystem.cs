...
namespace GameFramework
{
    public sealed class PredefinedSkill
    {
        ...
        public void Preload(ServerSkillSystem skillSystem)
        {
    ...
    public sealed class GfxSkillSenderInfo
    {
        ...
        public EntityInfo TargetGfxObj
        {
        ...
        public GfxSkillSenderInfo(TableConfig.Skill configData, int seq, int actorId, EntityInfo gfxObj, Scene scene)
        {
            m_Seq = seq;
        ...
        public GfxSkillSenderInfo(TableConfig.Skill configData, int seq, int actorId, EntityInfo gfxObj, int targetActorId, EntityInfo targetGfxObj, Scene scene)
    ...
    public sealed class ServerSkillSystem
    {
        ...
        public PredefinedSkill PredefinedSkill
        {
