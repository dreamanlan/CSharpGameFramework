...
public class Lua_System_Collections_ArrayList : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			else if(matchType(l,argc,2,typeof(System.Collections.ICollection))){
	...
	static public int Synchronized_s(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(System.Collections.IList))){
				System.Collections.IList a1;
				checkType(l,1,out a1);
			...
			else if(matchType(l,argc,1,typeof(System.Collections.ArrayList))){
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"System.ArrayList");
		addMember(l,Add);
		addMember(l,Clear);
