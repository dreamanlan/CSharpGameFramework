...
public class Lua_System_Int64 : LuaObject {
	...
	static public int Parse_s(IntPtr l) {
		try {
			...
			if(argc==1){
				...
				var ret=System.Int64.Parse(a1,a2);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
				...
				var ret=System.Int64.Parse(a1,a2,a3);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
	...
	static public int TryParse_s(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				checkType(l,1,out a1);
				System.Int64 a2;
				var ret=System.Int64.TryParse(a1,out a2);
				pushValue(l,true);
				pushValue(l,ret);
				pushValue(l,a2);
				return 3;
				...
				checkType(l,3,out a3);
				System.Int64 a4;
				var ret=System.Int64.TryParse(a1,a2,a3,out a4);
				pushValue(l,true);
				pushValue(l,ret);
				pushValue(l,a4);
				return 3;
	...
	static public int get_MaxValue(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,System.Int64.MaxValue);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_MinValue(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,System.Int64.MinValue);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(System.Int64),typeof(System.ValueType));
	}
}
