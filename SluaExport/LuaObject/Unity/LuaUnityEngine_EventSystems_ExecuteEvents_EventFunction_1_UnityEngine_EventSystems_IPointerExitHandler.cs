...
namespace SLua
{
    public partial class LuaDelegation : LuaObject
    {
        ...
        static internal int checkDelegate(IntPtr l,int p,out UnityEngine.EventSystems.ExecuteEvents.EventFunction<UnityEngine.EventSystems.IPointerExitHandler> ua) {
            ...
            {
                ua = (UnityEngine.EventSystems.ExecuteEvents.EventFunction<UnityEngine.EventSystems.IPointerExitHandler>)checkObj(l, p);
                return op;
            }
            LuaDelegate ld;
            ...
            if(ld.d!=null)
            {
                ua = (UnityEngine.EventSystems.ExecuteEvents.EventFunction<UnityEngine.EventSystems.IPointerExitHandler>)ld.d;
                return op;
            }
			LuaDLL.lua_pop(l,1);
