...
public class Lua_UnityEngine_CompositeCollider2D : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			UnityEngine.CompositeCollider2D o;
			o=new UnityEngine.CompositeCollider2D();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.CompositeCollider2D),typeof(UnityEngine.Collider2D));
	}
}
