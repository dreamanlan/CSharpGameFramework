...
public class Lua_StrUobjDict : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			if(argc==1){
				...
				System.Collections.Generic.IDictionary<System.String,UnityEngine.Object> a1;
				checkType(l,2,out a1);
				o=new StrUobjDict(a1);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
	...
	static public int Add(IntPtr l) {
		try {
			StrUobjDict self=(StrUobjDict)checkSelf(l);
			System.String a1;
			checkType(l,2,out a1);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(StrUobjDict),typeof(System.Collections.Generic.Dictionary<System.String,UnityEngine.Object>));
	}
}
