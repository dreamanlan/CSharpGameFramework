...
public class Lua_StorySystem_StoryArgValue : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ctor_s(IntPtr l) {
		try {
			StorySystem.StoryArgValue o;
			o=new StorySystem.StoryArgValue();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int InitFromDsl(IntPtr l) {
		try {
			StorySystem.StoryArgValue self=(StorySystem.StoryArgValue)checkSelf(l);
	...
	static public int get_c_NotArg(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,StorySystem.StoryArgValue.c_NotArg);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_c_Iterator(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,StorySystem.StoryArgValue.c_Iterator);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"StorySystem.StoryArgValue");
		addMember(l,ctor_s);
		...
		createTypeMetatable(l,null, typeof(StorySystem.StoryArgValue));
	}
}
