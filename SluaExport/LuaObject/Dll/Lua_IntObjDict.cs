...
public class Lua_IntObjDict : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			if(argc==1){
				...
				System.Collections.Generic.IDictionary<System.Int32,System.Object> a1;
	...
	static public int Add(IntPtr l) {
		try {
			IntObjDict self=(IntObjDict)checkSelf(l);
			System.Int32 a1;
			checkType(l,2,out a1);
			System.Object a2;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(IntObjDict),typeof(System.Collections.Generic.Dictionary<System.Int32,System.Object>));
	}
}
