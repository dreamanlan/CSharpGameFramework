...
public class Lua_GameFramework_Skill_Trigers_BuffToSelfTrigger : LuaObject {
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"GameFramework.Skill.Trigers.BuffToSelfTrigger");
		addMember(l,Reset);
		addMember(l,Execute);
		createTypeMetatable(l,constructor, typeof(GameFramework.Skill.Trigers.BuffToSelfTrigger),typeof(SkillSystem.AbstractSkillTriger));
	}
}
