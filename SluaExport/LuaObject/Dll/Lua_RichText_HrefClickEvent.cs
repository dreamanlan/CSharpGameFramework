...
public class Lua_RichText_HrefClickEvent : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ctor_s(IntPtr l) {
		try {
			RichText.HrefClickEvent o;
			o=new RichText.HrefClickEvent();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int Invoke(IntPtr l) {
		try {
			RichText.HrefClickEvent self=(RichText.HrefClickEvent)checkSelf(l);
			RichTextParser.HyperText a1;
	...
	static public void reg(IntPtr l) {
		LuaUnityEvent_RichTextParser_HyperText.reg(l);
		getTypeTable(l,"RichText.HrefClickEvent");
		addMember(l,ctor_s);
		addMember(l,Invoke);
		...
		addMember(l,Equals);
		createTypeMetatable(l,null, typeof(RichText.HrefClickEvent),typeof(LuaUnityEvent_RichTextParser_HyperText));
	}
}
