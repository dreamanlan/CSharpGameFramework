...
public class Lua_ShortList : LuaObject {
	...
	static public int Add(IntPtr l) {
		try {
			ShortList self=(ShortList)checkSelf(l);
			System.Int16 a1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(ShortList),typeof(System.Collections.Generic.List<System.Int16>));
	}
}
