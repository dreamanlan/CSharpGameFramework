...
public class Lua_IntQueue : LuaObject {
	...
	static public int Clear(IntPtr l) {
		try {
			IntQueue self=(IntQueue)checkSelf(l);
			self.Clear();
			pushValue(l,true);
			return 1;
		}
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(IntQueue),typeof(System.Collections.Generic.Queue<System.Int32>));
	}
}
