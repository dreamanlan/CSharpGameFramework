...
public class Lua_FloatList : LuaObject {
	...
	static public int Add(IntPtr l) {
		try {
			FloatList self=(FloatList)checkSelf(l);
			System.Single a1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(FloatList),typeof(System.Collections.Generic.List<System.Single>));
	}
}
