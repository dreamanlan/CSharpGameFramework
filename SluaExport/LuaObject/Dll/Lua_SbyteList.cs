...
public class Lua_SbyteList : LuaObject {
	...
	static public int Add(IntPtr l) {
		try {
			SbyteList self=(SbyteList)checkSelf(l);
			System.SByte a1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(SbyteList),typeof(System.Collections.Generic.List<System.SByte>));
	}
}
