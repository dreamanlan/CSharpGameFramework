...
public class Lua_ObjUobjDict : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			if(argc==1){
				...
				System.Collections.Generic.IDictionary<System.Object,UnityEngine.Object> a1;
				checkType(l,2,out a1);
				o=new ObjUobjDict(a1);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(ObjUobjDict),typeof(System.Collections.Generic.Dictionary<System.Object,UnityEngine.Object>));
	}
}
