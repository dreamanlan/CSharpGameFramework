...
public class Lua_UintList : LuaObject {
	...
	static public int Add(IntPtr l) {
		try {
			UintList self=(UintList)checkSelf(l);
			System.UInt32 a1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(UintList),typeof(System.Collections.Generic.List<System.UInt32>));
	}
}
