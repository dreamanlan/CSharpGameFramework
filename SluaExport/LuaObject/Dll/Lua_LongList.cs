...
public class Lua_LongList : LuaObject {
	...
	static public int Add(IntPtr l) {
		try {
			LongList self=(LongList)checkSelf(l);
			System.Int64 a1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(LongList),typeof(System.Collections.Generic.List<System.Int64>));
	}
}
