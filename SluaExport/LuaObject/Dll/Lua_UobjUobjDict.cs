...
public class Lua_UobjUobjDict : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			if(argc==1){
				...
				System.Collections.Generic.IDictionary<UnityEngine.Object,System.Int32> a1;
				checkType(l,2,out a1);
				o=new UobjUobjDict(a1);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
	...
	static public int Add(IntPtr l) {
		try {
			UobjUobjDict self=(UobjUobjDict)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(UobjUobjDict),typeof(System.Collections.Generic.Dictionary<UnityEngine.Object,System.Int32>));
	}
}
