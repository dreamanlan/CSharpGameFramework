...
public class Lua_RichTextParser_HyperTextAttrList : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ctor_s(IntPtr l) {
		try {
			RichTextParser.HyperTextAttrList o;
			o=new RichTextParser.HyperTextAttrList();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int Add(IntPtr l) {
		try {
			RichTextParser.HyperTextAttrList self=(RichTextParser.HyperTextAttrList)checkSelf(l);
			RichTextParser.HyperTextAttr a1;
	...
	static public int CopyTo__Int32__A_T__Int32__Int32(IntPtr l) {
		try {
			...
			System.Int32 a1;
			checkType(l,2,out a1);
			RichTextParser.HyperTextAttr[] a2;
	...
	static public int setItem(IntPtr l) {
		try {
			...
			int v;
			checkType(l,2,out v);
			RichTextParser.HyperTextAttr c;
			checkType(l,3,out c);
			self[v]=c;
			pushValue(l,true);
			return 1;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"RichTextParser.HyperTextAttrList");
		addMember(l,ctor_s);
		addMember(l,Add);
		...
		createTypeMetatable(l,null, typeof(RichTextParser.HyperTextAttrList),typeof(System.Collections.Generic.List<RichTextParser.HyperTextAttr>));
	}
}
