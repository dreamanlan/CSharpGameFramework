...
public class Lua_CharList : LuaObject {
	...
	static public int Add(IntPtr l) {
		try {
			CharList self=(CharList)checkSelf(l);
			System.Char a1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(CharList),typeof(System.Collections.Generic.List<System.Char>));
	}
}
