...
public class Lua_StorySystem_StoryConstValue : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ctor_s(IntPtr l) {
		try {
			StorySystem.StoryConstValue o;
			o=new StorySystem.StoryConstValue();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int InitFromDsl(IntPtr l) {
		try {
			StorySystem.StoryConstValue self=(StorySystem.StoryConstValue)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"StorySystem.StoryConstValue");
		addMember(l,ctor_s);
		...
		createTypeMetatable(l,null, typeof(StorySystem.StoryConstValue));
	}
}
