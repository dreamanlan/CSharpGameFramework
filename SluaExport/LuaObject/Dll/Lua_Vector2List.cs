...
public class Lua_Vector2List : LuaObject {
	...
	static public int Add(IntPtr l) {
		try {
			Vector2List self=(Vector2List)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(Vector2List),typeof(System.Collections.Generic.List<ScriptRuntime.Vector2>));
	}
}
