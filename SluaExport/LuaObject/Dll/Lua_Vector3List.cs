...
public class Lua_Vector3List : LuaObject {
	...
	static public int Add(IntPtr l) {
		try {
			Vector3List self=(Vector3List)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(Vector3List),typeof(System.Collections.Generic.List<ScriptRuntime.Vector3>));
	}
}
