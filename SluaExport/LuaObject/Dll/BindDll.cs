	...
	public class BindDll {
		public static Action<IntPtr>[] GetBindList() {
			Action<IntPtr>[] list= {
				...
				Lua_GameFrameworkMessage_EncodePosition.reg,
				Lua_GameFrameworkMessage_EncodePosition3D.reg,
				Lua_GameFrameworkMessage_Msg_CR_DlgClosed.reg,
				Lua_GameFrameworkMessage_Msg_CR_Enter.reg,
				Lua_GameFrameworkMessage_Msg_CR_GiveUpBattle.reg,
				Lua_GameFrameworkMessage_Msg_CR_GmCommand.reg,
				Lua_GameFrameworkMessage_Msg_CR_Observer.reg,
				Lua_GameFrameworkMessage_Msg_CR_OperateMode.reg,
				...
				Lua_GameFramework_ProtoHelper.reg,
