...
public class Lua_ByteList : LuaObject {
	...
	static public int Add(IntPtr l) {
		try {
			ByteList self=(ByteList)checkSelf(l);
			System.Byte a1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(ByteList),typeof(System.Collections.Generic.List<System.Byte>));
	}
}
