...
public class Lua_StorySystem_StrIStoryValueDict : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ctor_s(IntPtr l) {
		try {
			StorySystem.StrIStoryValueDict o;
			o=new StorySystem.StrIStoryValueDict();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int ctor__Int32_s(IntPtr l) {
		try {
			...
			o=new StorySystem.StrIStoryValueDict(a1);
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int Add(IntPtr l) {
		try {
			StorySystem.StrIStoryValueDict self=(StorySystem.StrIStoryValueDict)checkSelf(l);
			System.String a1;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"StorySystem.StrIStoryValueDict");
		addMember(l,ctor_s);
		...
		createTypeMetatable(l,null, typeof(StorySystem.StrIStoryValueDict),typeof(System.Collections.Generic.Dictionary<System.String,StorySystem.IStoryValue>));
	}
}
