...
public class Lua_StorySystem_StoryMessageHandlerList : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ctor_s(IntPtr l) {
		try {
			StorySystem.StoryMessageHandlerList o;
			o=new StorySystem.StoryMessageHandlerList();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int ctor__Int32_s(IntPtr l) {
		try {
			...
			o=new StorySystem.StoryMessageHandlerList(a1);
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int Add(IntPtr l) {
		try {
			StorySystem.StoryMessageHandlerList self=(StorySystem.StoryMessageHandlerList)checkSelf(l);
			StorySystem.StoryMessageHandler a1;
	...
	static public int setItem(IntPtr l) {
		try {
			...
			int v;
			checkType(l,2,out v);
			StorySystem.StoryMessageHandler c;
			checkType(l,3,out c);
			self[v]=c;
			pushValue(l,true);
			return 1;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"StorySystem.StoryMessageHandlerList");
		addMember(l,ctor_s);
		...
		createTypeMetatable(l,null, typeof(StorySystem.StoryMessageHandlerList),typeof(System.Collections.Generic.List<StorySystem.StoryMessageHandler>));
	}
}
