...
public class Lua_SkillSystem_IntSkillInstanceDict : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			if(argc==1){
				...
				System.Collections.Generic.IDictionary<System.Int32,SkillSystem.SkillInstance> a1;
				checkType(l,2,out a1);
				o=new SkillSystem.IntSkillInstanceDict(a1);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(SkillSystem.IntSkillInstanceDict),typeof(System.Collections.Generic.Dictionary<System.Int32,SkillSystem.SkillInstance>));
	}
}
