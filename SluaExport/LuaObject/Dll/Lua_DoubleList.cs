...
public class Lua_DoubleList : LuaObject {
	...
	static public int Add(IntPtr l) {
		try {
			DoubleList self=(DoubleList)checkSelf(l);
			System.Double a1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(DoubleList),typeof(System.Collections.Generic.List<System.Double>));
	}
}
