...
public class Lua_GameFramework_Skill_Trigers_UseImpactTrigger : LuaObject {
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"GameFramework.Skill.Trigers.UseImpactTrigger");
		addMember(l,Reset);
		addMember(l,Execute);
		createTypeMetatable(l,constructor, typeof(GameFramework.Skill.Trigers.UseImpactTrigger),typeof(SkillSystem.AbstractSkillTriger));
	}
}
