...
public class Lua_StrFloatDict : LuaObject {
	...
	static public int Add(IntPtr l) {
		try {
			StrFloatDict self=(StrFloatDict)checkSelf(l);
			System.String a1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(StrFloatDict),typeof(System.Collections.Generic.Dictionary<System.String,System.Single>));
	}
}
