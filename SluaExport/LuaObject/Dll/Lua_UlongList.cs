...
public class Lua_UlongList : LuaObject {
	...
	static public int Add(IntPtr l) {
		try {
			UlongList self=(UlongList)checkSelf(l);
			System.UInt64 a1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(UlongList),typeof(System.Collections.Generic.List<System.UInt64>));
	}
}
