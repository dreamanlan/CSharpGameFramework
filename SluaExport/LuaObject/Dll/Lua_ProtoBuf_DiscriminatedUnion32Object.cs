...
public class Lua_ProtoBuf_DiscriminatedUnion32Object : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ctor_s(IntPtr l) {
		try {
			ProtoBuf.DiscriminatedUnion32Object o;
			o=new ProtoBuf.DiscriminatedUnion32Object();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int ctor__Int32__Int32_s(IntPtr l) {
		try {
			...
			o=new ProtoBuf.DiscriminatedUnion32Object(a1,a2);
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int Is(IntPtr l) {
		try {
			ProtoBuf.DiscriminatedUnion32Object self;
	...
	static public int Reset_s(IntPtr l) {
		try {
			ProtoBuf.DiscriminatedUnion32Object a1;
			checkValueType(l,1,out a1);
			System.Int32 a2;
			checkType(l,2,out a2);
			ProtoBuf.DiscriminatedUnion32Object.Reset(ref a1,a2);
			pushValue(l,true);
			pushValue(l,a1);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"ProtoBuf.DiscriminatedUnion32Object");
		addMember(l,ctor_s);
		...
		createTypeMetatable(l,null, typeof(ProtoBuf.DiscriminatedUnion32Object),typeof(System.ValueType));
	}
}
