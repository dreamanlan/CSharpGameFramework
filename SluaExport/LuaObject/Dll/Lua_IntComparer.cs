...
public class Lua_IntComparer : LuaObject {
	...
	static new public int GetHashCode(IntPtr l) {
		try {
			IntComparer self=(IntComparer)checkSelf(l);
			System.Int32 a1;
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int Equals__Int32__Int32(IntPtr l) {
		try {
			IntComparer self=(IntComparer)checkSelf(l);
			System.Int32 a1;
			checkType(l,2,out a1);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,Equals__Int32__Int32);
		addMember(l,"Instance",get_Instance,null,false);
		createTypeMetatable(l,null, typeof(IntComparer));
	}
}
