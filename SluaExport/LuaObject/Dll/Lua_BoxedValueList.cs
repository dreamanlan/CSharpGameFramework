...
public class Lua_BoxedValueList : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ctor_s(IntPtr l) {
		try {
			BoxedValueList o;
			o=new BoxedValueList();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int AddBool(IntPtr l) {
		try {
			BoxedValueList self=(BoxedValueList)checkSelf(l);
			System.Boolean a1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(BoxedValueList),typeof(System.Collections.Generic.List<BoxedValue>));
	}
}
