...
public class Lua_StrIntDict : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			if(argc==1){
				...
				System.Collections.Generic.IDictionary<System.String,System.Int32> a1;
	...
	static public int Add(IntPtr l) {
		try {
			StrIntDict self=(StrIntDict)checkSelf(l);
			System.String a1;
			checkType(l,2,out a1);
			System.Int32 a2;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(StrIntDict),typeof(System.Collections.Generic.Dictionary<System.String,System.Int32>));
	}
}
