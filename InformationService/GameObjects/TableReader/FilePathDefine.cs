...
public class FilePathDefine_Client
{
	...
	public const string C_AttrDefine = C_RootPath + "Public/AttrDefine.dat";
	public const string C_Const = C_RootPath + "Public/Const.dat";
	...
	public const string C_SkillData = C_RootPath + "Public/SkillData.dat";
	public const string C_ImpactData = C_RootPath + "Public/ImpactData.dat";
	public const string C_SkillEvent = C_RootPath + "Public/SkillEvent.dat";
